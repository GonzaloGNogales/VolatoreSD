...
public class ClienteController {
	...
	private Empresa clienteEditando;
	...
	public String registrarCliente(@RequestParam String nifCliente, @RequestParam String mailCliente,
			@RequestParam int telefonoCliente, Empresa cliente) {
	...
	public String filtrarClientes(@RequestParam(required = false) String nombreCliente,
		...
		if ((!nombreCliente.equals("")) && (apellidosCliente.equals("")) && (nifCliente.equals("")) && (cpCliente == 0)
			...
			List<Empresa> clientesNombre = repClientes.findByNombreCliente(nombreCliente);
			...
			List<Empresa> clientesApellidos = repClientes.findByApellidosCliente(apellidosCliente);
			model.addAttribute("clientes", clientesApellidos);
		}

		else if ((nombreCliente.equals("")) && (apellidosCliente.equals("")) && (!nifCliente.equals(""))
				&& (cpCliente == 0) && (mailCliente.equals("")) && (telefonoCliente == 0)) {
			Empresa clienteNIF = repClientes.findByNifCliente(nifCliente);
			model.addAttribute("clientes", clienteNIF);
		}

		else if ((nombreCliente.equals("")) && (apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente != 0) && (mailCliente.equals("")) && (telefonoCliente == 0)) {
			List<Empresa> clientesCP = repClientes.findByCpCliente(cpCliente);
			model.addAttribute("clientes", clientesCP);
		}

		else if ((nombreCliente.equals("")) && (apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente == 0) && (!mailCliente.equals("")) && (telefonoCliente == 0)) {
			Empresa clienteMail = repClientes.findByMailCliente(mailCliente);
			model.addAttribute("clientes", clienteMail);
		}

		else if ((nombreCliente.equals("")) && (apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente == 0) && (mailCliente.equals("")) && (telefonoCliente != 0)) {
			Empresa clienteTelefono = repClientes.findByTelefonoCliente(telefonoCliente);
			model.addAttribute("clientes", clienteTelefono);
		}

		else if ((!nombreCliente.equals("")) && (!apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente == 0) && (mailCliente.equals("")) && (telefonoCliente == 0)) {
			List<Empresa> clientesNombreApellidos = repClientes.findByNombreClienteAndApellidosCliente(nombreCliente,
					apellidosCliente);
			model.addAttribute("clientes", clientesNombreApellidos);
				...
				&& (cpCliente == 0) && (mailCliente.equals("")) && (telefonoCliente == 0)) {
			Empresa clienteNombreNIF = repClientes.findByNombreClienteAndNifCliente(nombreCliente, nifCliente);
			model.addAttribute("clientes", clienteNombreNIF);
		}

		else if ((!nombreCliente.equals("")) && (apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente != 0) && (mailCliente.equals("")) && (telefonoCliente == 0)) {
			List<Empresa> clientesNombreCP = repClientes.findByNombreClienteAndCpCliente(nombreCliente, cpCliente);
			model.addAttribute("clientes", clientesNombreCP);
		}

		else if ((!nombreCliente.equals("")) && (apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente == 0) && (!mailCliente.equals("")) && (telefonoCliente == 0)) {
			Empresa clienteNombreMail = repClientes.findByNombreClienteAndMailCliente(nombreCliente, mailCliente);
			model.addAttribute("clientes", clienteNombreMail);
		}

		else if ((!nombreCliente.equals("")) && (apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente == 0) && (mailCliente.equals("")) && (telefonoCliente != 0)) {
			Empresa clienteNombreTelefono = repClientes.findByNombreClienteAndTelefonoCliente(nombreCliente,
					telefonoCliente);
			model.addAttribute("clientes", clienteNombreTelefono);
				...
				&& (cpCliente == 0) && (mailCliente.equals("")) && (telefonoCliente == 0)) {
			Empresa clienteApellidosNIF = repClientes.findByApellidosClienteAndNifCliente(apellidosCliente, nifCliente);
			model.addAttribute("clientes", clienteApellidosNIF);
		}

		else if ((nombreCliente.equals("")) && (!apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente != 0) && (mailCliente.equals("")) && (telefonoCliente == 0)) {
			List<Empresa> clientesApellidosCP = repClientes.findByApellidosClienteAndCpCliente(apellidosCliente,
					cpCliente);
			model.addAttribute("clientes", clientesApellidosCP);
				...
				&& (cpCliente == 0) && (!mailCliente.equals("")) && (telefonoCliente == 0)) {
			Empresa clienteApellidosMail = repClientes.findByApellidosClienteAndMailCliente(apellidosCliente,
					mailCliente);
			model.addAttribute("clientes", clienteApellidosMail);
				...
				&& (cpCliente == 0) && (mailCliente.equals("")) && (telefonoCliente != 0)) {
			Empresa clienteApellidosTelefono = repClientes.findByApellidosClienteAndTelefonoCliente(apellidosCliente,
					telefonoCliente);
			model.addAttribute("clientes", clienteApellidosTelefono);
				...
				&& (cpCliente != 0) && (mailCliente.equals("")) && (telefonoCliente == 0)) {
			Empresa clienteNIFCP = repClientes.findByNifClienteAndCpCliente(nifCliente, cpCliente);
			model.addAttribute("clientes", clienteNIFCP);
		}

		else if ((nombreCliente.equals("")) && (apellidosCliente.equals("")) && (!nifCliente.equals(""))
				&& (cpCliente == 0) && (!mailCliente.equals("")) && (telefonoCliente == 0)) {
			Empresa clienteNIFMail = repClientes.findByNifClienteAndMailCliente(nifCliente, mailCliente);
			model.addAttribute("clientes", clienteNIFMail);
		}

		else if ((nombreCliente.equals("")) && (apellidosCliente.equals("")) && (!nifCliente.equals(""))
				&& (cpCliente == 0) && (mailCliente.equals("")) && (telefonoCliente != 0)) {
			Empresa clienteNIFTelefono = repClientes.findByNifClienteAndTelefonoCliente(nifCliente, telefonoCliente);
			model.addAttribute("clientes", clienteNIFTelefono);
		}

		else if ((nombreCliente.equals("")) && (apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente != 0) && (!mailCliente.equals("")) && (telefonoCliente == 0)) {
			Empresa clienteCPMail = repClientes.findByCpClienteAndMailCliente(cpCliente, mailCliente);
			model.addAttribute("clientes", clienteCPMail);
		}

		else if ((nombreCliente.equals("")) && (apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente != 0) && (mailCliente.equals("")) && (telefonoCliente != 0)) {
			Empresa clienteCPTelefono = repClientes.findByCpClienteAndTelefonoCliente(cpCliente, telefonoCliente);
			model.addAttribute("clientes", clienteCPTelefono);
		}

		else if ((nombreCliente.equals("")) && (apellidosCliente.equals("")) && (nifCliente.equals(""))
				&& (cpCliente == 0) && (!mailCliente.equals("")) && (telefonoCliente != 0)) {
			Empresa clienteMailTelefono = repClientes.findByMailClienteAndTelefonoCliente(mailCliente, telefonoCliente);
			model.addAttribute("clientes", clienteMailTelefono);
		}

		else if ((!nombreCliente.equals("")) && (!apellidosCliente.equals("")) && (!nifCliente.equals(""))
				&& (cpCliente != 0) && (!mailCliente.equals("")) && (telefonoCliente != 0)) {
			Empresa clienteTodo = repClientes
	...
	public String ordenarClientes(@RequestParam int ordenCliente, Model model) {
		...
		case 0:
			...
			break;
		case 1:
			List<Empresa> clientes1 = repClientes.findAllByOrderByNombreClienteAsc();
			model.addAttribute("clientes", clientes1);
			break;
		case 2:
			List<Empresa> clientes2 = repClientes.findAllByOrderByNombreClienteDesc();
			model.addAttribute("clientes", clientes2);
			break;
		case 3:
			List<Empresa> clientes3 = repClientes.findAllByOrderByApellidosClienteAsc();
			model.addAttribute("clientes", clientes3);
			break;
		case 4:
			List<Empresa> clientes4 = repClientes.findAllByOrderByApellidosClienteDesc();
			model.addAttribute("clientes", clientes4);
			break;
		case 5:
			List<Empresa> clientes5 = repClientes.findAllByOrderByNifClienteAsc();
			model.addAttribute("clientes", clientes5);
			break;
		case 6:
			List<Empresa> clientes6 = repClientes.findAllByOrderByNifClienteDesc();
			model.addAttribute("clientes", clientes6);
			break;
		case 7:
			List<Empresa> clientes7 = repClientes.findAllByOrderByCpClienteAsc();
			model.addAttribute("clientes", clientes7);
			break;
		case 8:
			List<Empresa> clientes8 = repClientes.findAllByOrderByCpClienteDesc();
			model.addAttribute("clientes", clientes8);
			break;
		case 9:
			List<Empresa> clientes9 = repClientes.findAllByOrderByMailClienteAsc();
			model.addAttribute("clientes", clientes9);
			break;
		case 10:
			List<Empresa> clientes10 = repClientes.findAllByOrderByMailClienteDesc();
			model.addAttribute("clientes", clientes10);
			break;
		case 11:
			List<Empresa> clientes11 = repClientes.findAllByOrderByTelefonoClienteAsc();
			model.addAttribute("clientes", clientes11);
			break;
		case 12:
			List<Empresa> clientes12 = repClientes.findAllByOrderByTelefonoClienteDesc();
	...
	public String modificarCliente(@RequestParam long id, Model model) {
		...
		Empresa cliente = repClientes.findByIdCliente(id);
	...
	public String resultadoEdicionCliente(@RequestParam String nifCliente, @RequestParam String mailCliente,
			@RequestParam int telefonoCliente, Empresa c) {
